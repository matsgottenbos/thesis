    ...
    public static class DebugDelaysExporter {
        public static void Run() {
            ...
            foreach (DutyActivityModel activity in activities) {
                ...
                if (!AppConfig.IncludedRailwayUndertakings.Contains(activity.RailwayUndertaking)) continue;
            ...
            string fileName = Path.Combine(DevConfig.OutputFolder, "delays.json");
            File.WriteAllText(fileName, jsonStr);
            Console.WriteLine("Export done");
        }
    }

    public class ActivityDelayInfo {
